...
[![Version](https://img.shields.io/badge/version-0.14.0-green)](https://github.com/Nimbleway/agent-skills)
...
| **[Healthcare](skills/healthcare/)** | Extract structured practitioner data from practice websites and enrich existing provider lists with missing fields — names, credentials, specialties, contact info, education, reviews, and regulatory data across any healthcare vertical |
